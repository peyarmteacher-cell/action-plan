...
export const AiProjectWriterView: React.FC<AiProjectWriterViewProps> = ({
  ...
  const handleSaveToSchoolActionPlan = () => {
    ...
    const newProject: Project = {
      ...
      responsiblePerson: currentUser?.fullName || proposal.responsiblePerson || 'ครูผู้รับผิดชอบโครงการ',
      ...
      kpi: proposal.kpis,
      approvedBy: isTeacher ? undefined : school.directorName,
      approvedDate: isTeacher ? undefined : new Date().toISOString().split('T')[0],
    };
